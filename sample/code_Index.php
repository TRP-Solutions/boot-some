...
BootSome::$head->css('https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css');
BootSome::$head->css('https://use.fontawesome.com/releases/v5.15.4/css/all.css');
BootSome::$head->el('script',['src'=>'https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js']);
