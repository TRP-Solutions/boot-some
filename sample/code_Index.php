...
$head->css('https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css');
$head->css('https://use.fontawesome.com/releases/v5.3.1/css/all.css');

$head->el('script',['src'=>'https://code.jquery.com/jquery-3.3.1.slim.min.js']);
$head->el('script',['src'=>'https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js']);
