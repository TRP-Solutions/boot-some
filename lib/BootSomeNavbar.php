...
class BootSomeNavbarCollapse extends BootSomeComponent {
...
class BootSomeNavbarNav extends BootSomeComponent {
...
class BootSomeNavbarDropDown extends BootSomeComponent {
	public function __construct($parent){
