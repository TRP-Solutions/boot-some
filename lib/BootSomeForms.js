	...
	var initClasses = function(){
		var DatePickerTemplate = (()=>{
			...
			'<div class="bs-datepicker popover fade bs-popover-bottom" style="display: none;">'+
				...
				'<div class="popover-header">'+
					'<div class="btn-group">'+
						'<button class="btn btn-primary" data-action="prev"><span class="fas fa-chevron-left"></span></button>'+
						'<button class="btn btn-secondary" disabled="" data-content="month_year"></button>'+
						'<button class="btn btn-primary" data-action="next"><span class="fas fa-chevron-right"></span></button>'+
					'</div>'+
				'</div>'+
				'<div class="popover-body">'+
					'<div class="table-responsive">'+
						'<table class="table"><tbody data-calendar="">'+
							'<tr>'+
								'<th class="bs-datepicker-weeknumber"></th>'+
								'<th>M</th><th>T</th><th>W</th><th>T</th><th>F</th>'+
								'<th class="bs-datepicker-weekend">S</th>'+
								'<th class="bs-datepicker-weekend">S</th>'+
							'</tr>'+
							'<template data-name="calendar-row">'+
								'<tr data-calendar-row="">'+
									...
									'<td class="bs-datepicker-weekend"></td>'+
									'<td class="bs-datepicker-weekend"></td>'+
								'</tr>'+
		...
		class DatePicker {
			...
			write(date,month,year){
				...
				if(this.source && this.source.nodeName=='INPUT') this.source.value = value;
			...
			show(){
				...
				this.popover.querySelector('[tabindex]').focus();
				this.isShown = true;
			}
